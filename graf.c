...
void test_f2(int x, int y, int z)
{
...
#define DEMO_LINE_ANTIALIASING2
...
#ifdef DEMO_LINE_ANTIALIASING23
  S_INT_16_T i, x1, y1, x2, y2;
  PIXEL_T color;
  ...
  lb_gr_draw_line(NULL, 0, 0, ty_width, ty_height, 50,
		  lb_gr_12RGB(COLOR_BLUE | COLOR_SOLID), COPYMODE_COPY, LINEMODE_FILTERED);

  lb_gr_draw_line(NULL, ty_width, 0,  0, ty_height, 30,
		  lb_gr_12RGB(COLOR_RED | COLOR_SOLID), COPYMODE_COPY, LINEMODE_FILTERED);
	
  lb_gr_draw_line(NULL, ty_width/2,0, ty_width/2, ty_height, 20,
  ...
  lb_fb_open("/dev/fb0", "/dev/tty1", 1, 1,  0*RENDEROPTIONS_LINE | 0*RENDEROPTIONS_GRAPHICS_ONLY);
  lb_gr_clear_picture(NULL, lb_gr_12RGB(0x333 | COLOR_SOLID));
  lb_gr_draw_circle(NULL, ty_width/2, ty_height/2, ty_height/2-1, lb_gr_12RGB(0x100F), COPYMODE_COPY);
  lb_gr_delay(10000);
  lb_fb_exit(1);
#endif
  ...
  lb_fb_open("/dev/fb0", "/dev/tty1", 1, 1,  0*RENDEROPTIONS_LINE | 0*RENDEROPTIONS_GRAPHICS_ONLY);
  lb_gr_clear_picture(NULL, lb_gr_12RGB(0x333 | COLOR_SOLID));
  lb_gr_draw_circle_antialiasing_simple(NULL, ty_width/2, ty_height/2, 0.35*ty_height,20,
  ...
  lb_fb_open("/dev/fb0", "/dev/tty1", 10, 10, 0*RENDEROPTIONS_LINE | 0*RENDEROPTIONS_GRAPHICS_ONLY);
  lb_gr_draw_circle_antialiasing2(NULL, ty_width/2, ty_height/2, ty_height/5, lb_gr_12RGB(0xF00f), COPYMODE_BLEND);
  //lb_gr_draw_circle_antialiasing3(NULL, ty_width/2, ty_height/2, ty_height/3, lb_gr_12RGB(0x1Fa0), COPYMODE_BLEND);
  lb_gr_delay(5000);
  lb_fb_exit(1);
#endif
  ...
  lb_gr_draw_circle_filled_antialiasing_f(NULL, ty_width/3, ty_height/3, ty_height/3,
					  lb_gr_12RGB(COLOR_RED | COLOR_SOLID), COPYMODE_BLEND);
  lb_gr_draw_circle_filled_antialiasing_f(NULL, 2*ty_width/3, ty_height/3, ty_height/3,
					  lb_gr_12RGB(COLOR_LIME  | COLOR_SOLID), COPYMODE_BLEND);
  lb_gr_draw_circle_filled_antialiasing_f(NULL, ty_width/2, 2*ty_height/3, ty_height/3,
					  lb_gr_12RGB(COLOR_BLUE  | COLOR_SOLID), COPYMODE_BLEND);
  lb_gr_delay(10000);
  lb_fb_exit(1);
#endif
  ...
  lb_gr_draw_circle_filled_antialiasing(NULL, ty_width/3, ty_height/3, ty_height/4,
					lb_gr_12RGB(0xF00F),COPYMODE_BLEND);
  lb_gr_draw_circle_filled_antialiasing(NULL, 2*ty_width/3, ty_height/3, ty_height/4,
					lb_gr_12RGB(0xf0F0), COPYMODE_BLEND);
  lb_gr_draw_circle_filled_antialiasing(NULL, ty_width/2, 2*ty_height/3, ty_height/4,
  ...
  lb_gr_draw_circle_arc(NULL, ty_width/2, ty_height/2, ty_height/2-1,
  ...
  /* Example 1: */
  //lb_gr_draw_ellipse(NULL, ty_width/2, ty_height/2, ty_width*0.25, ty_height*0.22,lb_gr_12RGB(COLOR_WHITE), COPYMODE_COPY);
	
  /* Example 2: */
  //lb_gr_draw_ellipse_antialiasing2(NULL, ty_width/2, ty_height/2, ty_width*0.25,ty_height*0.22, lb_gr_12RGB(COLOR_WHITE), COPYMODE_BLEND);

  /* Example 3: */
  lb_gr_draw_ellipse_antialiasing3(NULL, ty_width/2, ty_height/2, ty_width*0.25,ty_width*0.22,lb_gr_12RGB(COLOR_WHITE),
				   COPYMODE_BLEND); 
  ...
  if (0) for (angle=0;angle<=M_PI/2;angle+=1*M_PI/180)
	   {
	     ...
	     lb_gr_draw_ellipse_rotated_antialiasing(NULL, ty_width/2, ty_height/2, ty_width*0.45,ty_width*0.10, angle, 8, 100,
						     lb_gr_12RGB(COLOR_BLUE), COPYMODE_BLEND, LINEMODE_FILTERED);
	     lb_gr_delay(100);
	   }
  lb_gr_delay(10000);
  lb_fb_exit(1);
  ...
  for (i=0;i<10000;i++)
    {
      ...
      C.x=rand() % ty_width;
      C.y=rand() % ty_height;
      lb_gr_draw_triangle_fill_i(NULL, A, B, C, lb_gr_12RGB(COLOR_SOLID | rand()%0x0FFF), COPYMODE_BLEND);
    }
  end=clock();
  ...
  //#define DEMO_TRIANGLE_FB
#ifdef DEMO_TRIANGLE_FB
  S_INT_16_T i;
  POINT_2D_INT_T A, B, C, D, X;
  clock_t begin, end;
  ...
  for (i=0;i<10000;i++)
    {
      ...
      C.x=rand() % ty_width;
      C.y=rand() % ty_height;
      lb_fb_draw_triangle_fill_i(ty_fb_main, A, B, C, rand() % 0xFF, rand() % 0xFF, rand() % 0xFF, 0);
    }
  end=clock();
  printf("time elapsed = %f\n",(double)(end - begin) / CLOCKS_PER_SEC);
  //lb_gr_delay(10000);
  ...
  //#define DEMO_TRANSPARENCY
#ifdef DEMO_TRANSPARENCY
  S_INT_16_T i, j;
  U_INT_8_T r,g,b,t;
  ...
  for (i=0;i<ty_height;i++)
    for (j=0;j<ty_width;j++)
      {
	lb_fb_draw_pixel(ty_fb_main, j, i, 0,0,0,255);
	lb_fb_get_pixel(ty_fb_main, j, i, &r, &g, &b, &t);
	lb_fb_draw_pixel(ty_fb_main, j, i, t,0,0,0);
      }
