...
#define S_INT_8_T char
#define S_INT_16_T short
#define S_INT_32_T long
...
#define COPYMODE_T U_INT_32_T

/* Simple classic operators */
#define COPYMODE_FRAMEBUFFER             0x00  /* Direct copy to framebuffer */
#define COPYMODE_COPY                    0x01  
/* Simple classic operators */
#define COPYMODE_AND                     0x02
#define COPYMODE_OR                      0x03
#define COPYMODE_XOR                     0x04
#define COPYMODE_NOT_SRC                 0x05
#define COPYMODE_NOT_DST                 0x06
#define COPYMODE_ADD                     0x07
#define COPYMODE_SRC_MINUS_DST           0x08
#define COPYMODE_DST_MINUS_SRC           0x09
#define COPYMODE_AVG                     0x0A
#define COPYMODE_BLEND                   0x0B
#define COPYMODE_MULTIPLY                0x0C
#define COPYMODE_SRC_DIV_DST             0x0D
#define COPYMODE_DST_DIV_SRC             0x0E
#define COPYMODE_RESERVED0               0x0F
#define COPYMODE_RESERVED1               0x10
#define COPYMODE_RESERVED2               0x11
#define COPYMODE_RESERVED3               0x12
#define COPYMODE_RESERVED4               0x13
   
/* Porter-Duff Operators */
#define COPYMODE_PORTERDUFF_CLEAR_DST    0x14    /* Clears the SRC regardless of its value and that of DST */
#define COPYMODE_PORTERDUFF_COPY_SRC     0x15    /* Copies SRC to DST regardless of DST */
#define COPYMODE_PORTERDUFF_LEAVES_DST   0x16    /* Leaves DST as it is regardless of SRC.  
	   				          This is a trivial case left for completness of the 12 modes. */
#define COPYMODE_PORTERDUFF_SRC_OVER_DST 0x17
#define COPYMODE_PORTERDUFF_DST_OVER_SRC 0x18
#define COPYMODE_PORTERDUFF_SRC_IN_DST   0x19
#define COPYMODE_PORTERDUFF_DST_IN_SRC   0x1A
#define COPYMODE_PORTERDUFF_SRC_OUT_DST  0x1B
#define COPYMODE_PORTERDUFF_DST_OUT_SRC  0x1C
#define COPYMODE_PORTERDUFF_SRC_ATOP_DST 0x1D
#define COPYMODE_PORTERDUFF_DST_ATOP_SRC 0x1E
#define COPYMODE_PORTERDUFF_XOR          0x1F
...
#define COPYMODE_COPYMODE_MASK     0b00000000000000000000000000011111
#define COPYMODE_PIXELMODE_MASK    0b00000000000000000000000011100000
#define COPYMODE_PIXELBG_R_MASK    0b00000000000000000000111100000000
#define COPYMODE_PIXELBG_G_MASK    0b00000000000000001111000000000000
#define COPYMODE_PIXELBG_B_MASK    0b00000000000011110000000000000000
#define COPYMODE_SCALEX_MASK       0b00000011111100000000000000000000
#define COPYMODE_SCALEY_MASK       0b11111100000000000000000000000000

#define COPYMODE_PIXELMODE_0       0b00000000000000000000000000000000
#define COPYMODE_PIXELMODE_1       0b00000000000000000000000000100000
#define COPYMODE_PIXELMODE_2       0b00000000000000000000000001000000
#define COPYMODE_PIXELMODE_3       0b00000000000000000000000001100000

#define COPYMODE_PIXELMODE_SHIFT       5 
#define COPYMODE_PIXELBG_R_SHIFT       8
#define COPYMODE_PIXELBG_G_SHIFT      12
#define COPYMODE_PIXELBG_B_SHIFT      16
#define COPYMODE_SCALEX_SHIFT         20
#define COPYMODE_SCALEY_SHIFT         26

/* These macros help the user setting an arbitrary "pixel size" */
#define COPYMODE_SCALE_X(X) (((X-1)<<COPYMODE_SCALEX_SHIFT) & COPYMODE_SCALEX_MASK)
#define COPYMODE_SCALE_Y(X) (((X-1)<<COPYMODE_SCALEY_SHIFT) & COPYMODE_SCALEY_MASK)
#define COPYMODE_BGCOLOR(X) ((X<<8) & (COPYMODE_PIXELBG_R_MASK | COPYMODE_PIXELBG_G_MASK | COPYMODE_PIXELBG_B_MASK) )
...
typedef struct 
  {
    U_INT_8_T r:N_BITS_R;
    U_INT_8_T g:N_BITS_G;
    U_INT_8_T b:N_BITS_B;
    U_INT_8_T a:N_BITS_A;
  } PIXEL_T;
...
typedef struct
{
  ...
  S_INT_16_T MAX_ROWS;     /* Maximum (total) number of rows stored in memory */  
  S_INT_16_T MAX_ROWS_V;   /* Visible number of rows*/
  S_INT_16_T MAX_COLS;
  /*  S_INT_16_T n_row;       Number of "rows" which have been received*/
  S_INT_16_T a_row;        /* Index of the oldest row that was written */
  S_INT_16_T b_row;        /* Index of the row of the next cell to be written */
  S_INT_16_T w_col;        /* Index of the column of the next cell to be written */
  S_INT_16_T s_row;        /* Index of the row of the next cell to be "seen" (cursor) */
  S_INT_16_T s_col;        /* Index of the column of the next cell to be "seen" (cursor) */
  S_INT_16_T n_back;       /* Number of rows "backwards" counted from the next cell to be written */
  S_INT_16_T n_back_adj;   /* Adjusted number of rows "backwards", to add hysteresis */
