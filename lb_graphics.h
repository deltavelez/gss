...
void lb_gr_resize(S_INT16_T width, S_INT16_T height);
...
void       lb_gr_bitmap_rotate_sampling(PICTURE_T *pic_src, PICTURE_T *pic_dst, FLOAT_T angle, U_INT8_T n_samples,
...
S_INT8_T  lb_gr_BMPfile_load_to_matrix_gs(const char *filename, MATRIX_R_T *P);
...
void       lb_gr_delay(S_INT32_T delay);
...
void       lb_gr_draw_circle_antialiasing(PICTURE_T *Pic, FLOAT_T xc, FLOAT_T yc, FLOAT_T radius, FLOAT_T w, PIXEL_T color,
					  COPYMODE_T copymode); 
void       lb_gr_draw_circle_antialiasing2(PICTURE_T *Pic, S_INT16_T xc, S_INT16_T yc, S_INT16_T radius, PIXEL_T color,
					   COPYMODE_T copymode); 
void       lb_gr_draw_circle_antialiasing3(PICTURE_T *Pic, S_INT16_T xc, S_INT16_T yc, S_INT16_T radius, PIXEL_T color,
					   COPYMODE_T copymode); 
void       lb_gr_draw_circle_antialiasing_simple(PICTURE_T *Pic, FLOAT_T xc, FLOAT_T yc, FLOAT_T radius, FLOAT_T w, PIXEL_T color,
						 COPYMODE_T copymode); 
void       lb_gr_draw_circle_arc(PICTURE_T *Pic, S_INT16_T xc, S_INT16_T yc, S_INT16_T radius, FLOAT_T a1, FLOAT_T a2,
				 PIXEL_T color, COPYMODE_T mode); 
void       lb_gr_draw_circle_filled_antialiasing(PICTURE_T *Pic, S_INT16_T xc, S_INT16_T yc, S_INT16_T radius, PIXEL_T color,
						 COPYMODE_T copymode);
...
void       lb_gr_draw_circle_filled(PICTURE_T *Pic, S_INT16_T xc, S_INT16_T yc, S_INT16_T radius, PIXEL_T color,
					 COPYMODE_T mode);
void       lb_gr_draw_circle_filled_slow(PICTURE_T *Pic, S_INT16_T xc, S_INT16_T yc, S_INT16_T radius, PIXEL_T color,
					 COPYMODE_T copymode);
...
void       lb_gr_draw_ellipse_rotated_antialiasing(PICTURE_T *Pic, FLOAT_T xc, FLOAT_T yc, FLOAT_T a, FLOAT_T b, FLOAT_T angle, FLOAT_T w, S_INT16_T n_q1, PIXEL_T color, COPYMODE_T copymode, LINEMODE_T linemode);
...
void       lb_gr_draw_line(PICTURE_T *Pic, FLOAT_T x0, FLOAT_T y0, FLOAT_T x1, FLOAT_T y1, FLOAT_T w, PIXEL_T color,
			   COPYMODE_T copymode, LINEMODE_T linemode);
void       lb_gr_draw_line1(PICTURE_T *Pic, S_INT16_T x0, S_INT16_T y0, S_INT16_T x1, S_INT16_T y1, PIXEL_T color,
			    COPYMODE_T copymode);

void       lb_gr_draw_line1_f(PICTURE_T *Pic, FLOAT_T x0, FLOAT_T y0, FLOAT_T x1, FLOAT_T y1, PIXEL_T color, COPYMODE_T copymode);

void       lb_gr_draw_line2(PICTURE_T *Pic, S_INT16_T _x0, S_INT16_T _y0, S_INT16_T _x1, S_INT16_T _y1, PIXEL_T color,
			    COPYMODE_T copymode);
void       lb_gr_draw_line3(PICTURE_T *Pic, S_INT16_T _x0, S_INT16_T _y0, S_INT16_T _x1, S_INT16_T _y1, PIXEL_T color,
			    COPYMODE_T copymode);
void       lb_gr_draw_line_antialiasing(PICTURE_T *Pic, FLOAT_T _xr0, FLOAT_T _yr0, FLOAT_T _xr1, FLOAT_T _yr1, FLOAT_T w,
					PIXEL_T color, COPYMODE_T copymode);
void       lb_gr_draw_line_antialiasing2(PICTURE_T *Pic, S_INT16_T _x0, S_INT16_T _y0, S_INT16_T _x1, S_INT16_T _y1,
					 PIXEL_T color, COPYMODE_T copymode);

void       lb_gr_draw_line_antialiasing2_f(PICTURE_T *Pic, FLOAT_T _x0, FLOAT_T _y0, FLOAT_T _x1, FLOAT_T _y1,
					 PIXEL_T color, COPYMODE_T copymode);

void       lb_gr_draw_line_antialiasing3(PICTURE_T *Pic, S_INT16_T _x0, S_INT16_T _y0, S_INT16_T _x1, S_INT16_T _y1,
					 PIXEL_T color, COPYMODE_T copymode);
...
void       lb_gr_draw_rectangle(PICTURE_T *Pic, S_INT16_T x0, S_INT16_T y0, S_INT16_T x1, S_INT16_T y1,  PIXEL_T color,
				COPYMODE_T copymode);
...
void       lb_gr_draw_rectangle_solid(PICTURE_T *Pic, S_INT16_T x0, S_INT16_T y0, S_INT16_T x1, S_INT16_T y1, PIXEL_T color);
...
void lb_gr_render_picture(PICTURE_T *Pic, S_INT16_T x, S_INT16_T y, COPYMODE_T copymode, RENDERMODE_T rendermode);
...
//void lb_gr_project_3d_to_2d_analytical(VIEWPORT_3D_T vp3d, MATRIX_R_T *Rot, VECTOR_R_T *Pa, U_INT16_T *xp, U_INT16_T *yp, U_INT8_T *flag);
//void lb_gr_project_3d_to_2d_analytical_two_vectors(VIEWPORT_3D_T vp3d, VECTOR_R_T *V1, VECTOR_R_T *V2, VECTOR_R_T *Pa, U_INT16_T *xp, U_INT16_T *yp, U_INT8_T *flag);
